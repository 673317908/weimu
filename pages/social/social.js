...
      menus:['shareAppMessage','shareTimeline']
    ...
    if (!self.data.userSession.sessionId) {
      ...
      if(publishTopicUserRight=="0")
      {
        ...
        wx.lin.showDialog({
          ...
          confirmText: "ماقۇل",
          confirmColor: "#f60",
          content: "ھوقوقىڭىز يىتىشمىدى، "+min_posttopic_user_memberName+" دىن يۇقۇرى دەرىجىلىك ئەزالارلا يوللىيالايدۇ، جۇغلانما يىغىپ دەرىجىڭىزنى ئۆستۈرەمسىز؟",
          success: (res) => {
            if (res.confirm) {
              wx.navigateTo({
  ...
  sendSubscribeMessage(e) {
    ...
    wx.lin.showDialog({
      type: "confirm",
      title: "يېڭىلانغانلىق ئۇقتۇرىشى",
      showTitle: true,
      confirmText: "ماقۇل",
      confirmColor: "#f60",
      content: "قوبۇل قىلامسىز؟",
      success: (res) => {
        if (res.confirm) {
